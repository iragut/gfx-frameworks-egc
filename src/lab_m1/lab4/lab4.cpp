...
void Lab4::RenderScene() {
    ...
    modelMatrix = glm::mat4(1);
    modelMatrix *= transform3D::Translate(0.0f, 0.5f, -1.5f);  // Position of the second cube
    modelMatrix *= transform3D::Translate(translateXX, 0, translateZZ);  // Orbit around second cube
...
void Lab4::OnInputUpdate(float deltaTime, int mods)
{
    ...
    if (window->KeyHold(GLFW_KEY_Z)) {
        ...
        translateXX = orbitRadius * cos(orbitAngle);  // X-axis orbit position
        translateZZ = orbitRadius * sin(orbitAngle);  // Z-axis orbit position
    }
}
